                ...
                <div className="infoNoMenu">
                    ...
                    <div className="col-md-12 border-0 float-left p-0">
                        <p className="lh15 subtitolSuperior">{t('accessibilitatDeclaracio1')} <a
                            ...
                            rel="noopener noreferrer" tabIndex="502" aria-labelledby={t('accessibilitatDecret')} aria-describedby={t('accedirEnllas') + t('accessibilitatDecret')}>{t('accessibilitatDecret')}</a> {t('accessibilitatDeclaracio2')}
                        </p>
                        <p className="lh15 subtitolInterior">{t('accessibilitatDeclaracio3')} <a href="https://www.caib.es/carpeta/"
                                                                                target="_blank"
                                                                                rel="noopener noreferrer" tabIndex="503" aria-labelledby="https://www.caib.es/carpeta/" aria-describedby={t('accedirEnllas') + "https://www.caib.es/carpeta/"}>https://www.caib.es/carpeta/</a> {t('accessibilitatDeclaracio4')}
                        </p>
                        ...
                        <p className="lh15 subtitolInterior">{t('accessibilitatCompliment1')} <a
                            href="https://www.boe.es/diario_boe/txt.php?id=BOE-A-2018-12699" target="_blank"
                            rel="noopener noreferrer" tabIndex="504" aria-labelledby={t('accessibilitatDecret')} aria-describedby={t('accedirEnllas') + t('accessibilitatDecret')}>{t('accessibilitatDecret')}</a>{t('accessibilitatCompliment2')}
                        </p>
                        ...
                        <p className="lh15 subtitolInterior">{t('accessibilitatNoAccessible2')} <a
                            href="https://www.boe.es/diario_boe/txt.php?id=BOE-A-2018-12699" target="_blank"
                            rel="noopener noreferrer" tabIndex="505" aria-labelledby={t('accessibilitatDecret')} aria-describedby={t('accedirEnllas') + t('accessibilitatDecret')}>{t('accessibilitatDecret')}</a>.</p>
                        <div className="mb-3">
                        ...
                        <p className="lh15 subtitolInterior">{t('accessibilitatObservacions1')} <a
                            ...
                            target="_blank" rel="noopener noreferrer" tabIndex="506" aria-labelledby={t('contacteAccess')} aria-describedby={t('accedirEnllas') + t('contacteAccess')}>{t('accessibilitatObservacions5')}</a>.</p>
                        <p className="lh15 subtitolInterior">{t('accessibilitatObservacions2')} <a href="http://dgtic.caib.es/"
                                                                                  target="_blank"
                                                                                  rel="noopener noreferrer" tabIndex="507" aria-labelledby={t('accessibilitatObservacions3')} aria-describedby={t('accedirEnllas') + t('accessibilitatObservacions3')}>{t('accessibilitatObservacions3')}</a> {t('accessibilitatObservacions4')}
                        </p>
                        ...
                        <p className="lh15 subtitolInterior">{t('accessibilitatProcediment1')} <a
                            href="https://www.boe.es/diario_boe/txt.php?id=BOE-A-2018-12699" target="_blank"
                            rel="noopener noreferrer" tabIndex="508" aria-labelledby={t('accessibilitatDecret')} aria-describedby={t('accedirEnllas') + t('accessibilitatDecret')}>{t('accessibilitatDecret')}</a> {t('accessibilitatProcediment2')}
                        </p>
                        ...
                        <p className="lh15 subtitolInterior"><a className="mr-auto" href="https://www.w3.org/WAI/WCAG1AA-Conformance"
                                               target="_blank" rel="noopener noreferrer" tabIndex="509" aria-label={t('accessibilitatWAI')} aria-describedby={t('accessibilitatAccesWAI')}>
