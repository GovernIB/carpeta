...
class Index extends Component {
  ...
  render() {
    ...
    if (auth === "1" && usuariNomComplet != null) {
      ...
      infoUsuari = (
        <div className="imc-titol usuari ocultarMobil z-5" style={styleColorMenu}>
            ...
            <div id="contingutok" className="pt-2">
              <Switch>
                ...
                <Route
                  ...
                  render={(props) => {
                    return (
                      <PluginHtml
                        {...props}
                        seccioContext={props.match.params.seccioContext}
                        pluginContext={props.match.params.pluginContext}
                      />
                    );
                  }}
                />
                  ...
                  render={(props) => {
                    return (
                      <PluginHtml
                        ...
                        seccioContext={"0"}
                        pluginContext={props.match.params.pluginContext}
                        pluginParameter={props.match.params.pluginParameter}
                      />
                    );
                  }}
                />
                ...
                <Route
                  ...
                  render={(props) => {
                    return (
                      <PluginHtml {...props} seccioContext={"0"} pluginContext={props.match.params.pluginContext} />
                    );
                  }}
                />
                <Route
                  ...
                  render={(props) => {
                    return (
                      <PluginReact {...props} seccioContext={"0"} pluginContext={props.match.params.pluginContext} />
                    );
                  }}
                />
