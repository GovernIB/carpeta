		...
		<div class="imc-cap--fixe" id="imc-cap--fixe">
			...
			<header class="imc-cap" id="imc-cap" data-autenticacio="a">
				<div class="imc--c">
					...
					<!-- Menú de navegació per a mòbils 
					<nav id="navigation" class="opcionsMenu no-visible">

						<div class="control-menu">
							<a href="#navigation" class="open"><span>MENU</span></a>
							<a href="#" class="close"><span>TANCAR</span></a>
						</div>
						
						<ul class="nav-items">
							<li class="front"><a href="index.html"> <span>Inici</span></a></li>
							<li class="mobile"><a href="tramitList.html"><span>Tràmits</span></a></li>
							<li class="mobile"><a href="registreList.html"><span>Registres</span></a></li>
							<li class="net"><a href="index.html?idioma=es"><span>Castellà</span></a></li>
							<li class="sharePoint"><a href="accessibilitat.html"><span>Accessibilitat</span></a></li>
							<li class="data"><a href="#" onclick="sortirCarpeta()"><span>Sortir</span></a></li>
						</ul>
				...
				<div class="imc--c">
					<div class="imc--dades">
						<div>
							<ul>
								<li class="menuInici">
									<a href="index.html"><p class="hide">Inici</p></a>
								</li>
								<li>
									<a href="#"><p>Les meves gestions</p></a>
									<ul>
										<li><a href="tramitList.html">Tràmits no acabats</a></li>
										<li><a href="registreList.html">Els meus registres</a></li>
								    </ul>
								</li>
							</ul>
						</div>
