        ...
        <sec:authorize access="isAuthenticated()">
            <li class="nav-item dropdown colorVerde">
                ...
                <div class="dropdown-menu dropdown-menu-right marg0" aria-labelledby="menu">
                    <a class="dropdown-item movil" href="<c:url value="/tramite/list"/>"><span class="oi oi-document" title="" aria-hidden="true"></span> <fmt:message key="menu.tramites.no.acabados"/></a>
