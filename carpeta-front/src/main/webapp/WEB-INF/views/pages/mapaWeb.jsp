        ...
        <div class="table-responsive">
            <table class="table table-hover" style="width:100%">
                <tbody>
                    ...
                    <tr class="text-uppercase backWhite">
                        <td class="border-0 pl-5"><a href="<c:url value="/tramite/list"/>"><fmt:message key="mapaWeb.tramites"/></a><sec:authorize access="!isAuthenticated()"><span class="textClave"><img src="${pageContext.request.contextPath}/static/img/clave2.png" alt="<fmt:message key="accesibilidad.acceso.clave"/>" title="<fmt:message key="accesibilidad.acceso.clave"/>"/><fmt:message key="accesibilidad.acceso.texto"/></sec:authorize></span></td>
                    </tr>
                    <tr class="text-uppercase backWhite">
