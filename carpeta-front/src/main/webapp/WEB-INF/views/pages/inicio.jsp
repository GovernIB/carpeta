...
<%--                </ul>--%>
    ...
    <div class="card col-md-6 border-0 margen-left-clave">
        ...
        <div class="pt3 pb-3">
            ...
            <p class="lh15">
                <span class="oi oi-external-link verde pt-1 pr-1 pb-1" title="" aria-hidden="true"></span><a class="_btn _btn-primary" href="<c:url value="/anonim"/>" role="button"><fmt:message key="inicio.clau.tramitacio.acces"/></a>
            </p>
        </div>
