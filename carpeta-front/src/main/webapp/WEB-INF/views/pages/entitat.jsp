...
<body>
    ...
    <div class="contenedor">
        ...
        <!-- Zona Contingut -->
        <div class="imc-continguts contingut-entitat">
            <div class="pt-2">
                                        ...
                                        <c:forEach items="${entitats}" var="entitat" varStatus="index">
                                            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 pl-0">
                                                <button class="card col-md-12 align-items-lg-center capsaPlugin pt-3 alert" onclick="location.href='<c:url value="/e/${entitat.codi}"/>'" tabindex=${100 + index.index}>
                                                    ...
                                                    <h2 class="apartat titolPlugin titol h3">${entitat.nom.getTraduccio(langActual).valor}</h2>
...
<script>
  ...
  // S'afegeix el menu_lateral.js directament perquè no va bé copiant directament el de react, per l'export de la funció
  ...
  window.onload=menuDesllisantJS;
