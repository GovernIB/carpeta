...
function newInici(compoWeb, nom) {
	setTimeout(newIniciReact.bind(null,compoWeb,nom) , 1);
}

function newAccessibilitat(compoWeb, nom) {
	setTimeout(newAccessibilitatReact.bind(null,compoWeb,nom) , 1);
}
...
function newRegistres(compoWeb, nom) {
	setTimeout(newRegistresReact.bind(null,compoWeb,nom) , 1);
}

function newDetallRegistre(compoWeb, param) {
	setTimeout(newDetallRegistreReact.bind(null,compoWeb,param) , 1);
}

function newNotificacions(compoWeb, nom) {
	setTimeout(newNotificacionsReact.bind(null,compoWeb,nom) , 1);
}

function newMapaWeb(compoWeb, nom) {
	setTimeout(newMapaWebReact.bind(null,compoWeb,nom) , 1);
}
