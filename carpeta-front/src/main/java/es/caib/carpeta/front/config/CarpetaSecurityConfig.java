...
public class CarpetaSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    @Autowired
    private CarpetaAuthProvider carpetaAuthProvider;
    ...
    public void configure(AuthenticationManagerBuilder auth) throws Exception {
        auth.authenticationProvider(carpetaAuthProvider);
    }

    @Override
    protected void configure(HttpSecurity http) throws Exception {
        http.authorizeRequests().antMatchers("/","/inicio","/salir","/js/**","/css/**","/fonts/**","/imgs/**","/static/**","/accesibilidad", "/mapaWeb", "/anonim", "/anonim/").permitAll()
                .and()
