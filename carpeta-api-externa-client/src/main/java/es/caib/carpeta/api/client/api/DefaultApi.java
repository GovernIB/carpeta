...
import es.caib.carpeta.api.client.services.Configuration;
import es.caib.carpeta.api.client.services.Pair;

import javax.ws.rs.core.GenericType;

import es.caib.carpeta.api.client.model.PaginaAcces;
...
@javax.annotation.Generated(value = "io.swagger.codegen.v3.generators.java.JavaClientCodegen", date = "2021-08-06T10:49:23.474020800+02:00[Europe/Paris]")public class DefaultApi {
  ...
  public String echo(String echoInput) throws ApiException {
    Object localVarPostBody = null;
    // create path and map variables
    String localVarPath = "/services/secure".replaceAll("\\{format\\}","json");
