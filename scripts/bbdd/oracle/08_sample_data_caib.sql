...
INSERT INTO car_entitat(entitatid, nomid, codidir3, activa, colormenu, versio, commit, 
            ...
            webentitat, pluginloginid, accessibilitatca) VALUES (100, 111, 'A04003003', 1, '32814B', '1.1.1', NULL, NULL, NULL, 'caib', 104, 105, 106, 107, 'http://www.caib.es/sites/suportinformatic/es/inicio-5586/?campa=yes', 'suport@caib.es', '971177070', '<p><strong>© Govern Illes Balears</strong></p><p><a href="http://www.caib.es/govern/organigrama/area.do?coduo=2390499' || chr(38) || 'amp;lang=ca">Direcció General de Comunicació</a><a href="http://www.caib.es/govern/organigrama/planol.do?coduo=2390499' || chr(38) || 'amp;lang=ca">: Passeig de Sagrera, 2 - 07012 Palma</a></p><p></p>Telèfon 971177166 - Fax 971176348<p></p>', 'https://www.caib.es', NULL, '<div class="col-md-12 border-0 float-left p-0"><h3 class="apartat titol h3">Títol apartat</h3><p class="lh15 subtitolInterior" id="identificadorParagraf">Lorem ipsum dolor sit amet <a href="url" target="_blank" rel="noopener noreferrer" tabindex="de 502 per envant" aria-labelledby="identificadorParagraf">text enllaç</a>consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud.</p><div class="mb-3"><ul class="lh15 pl-5 pt-1"><li>Sed ut perspiciatis unde omnis iste.</li><li>Quasi architecto beatae vitae dicta sunt explicabo.</li></ul></div><p class="lh15 subtitolInterior" id="identificadorParagraf"><img src="urlImatge" title="text descriptiu imatge" alt="text descriptiu imatge"></p></div>');
...
INSERT INTO car_traducciomap(traducciomapid, idiomaid, valor) VALUES (96, 'en', 'Regweb 3.2');
INSERT INTO car_traducciomap(traducciomapid, idiomaid, valor) VALUES (96, 'ca', 'Regweb 3.2');
INSERT INTO car_traducciomap(traducciomapid, idiomaid, valor) VALUES (96, 'es', 'Regweb 3.2');
INSERT INTO car_traducciomap(traducciomapid, idiomaid, valor) VALUES (97, 'en', 'Regweb 3.2');
INSERT INTO car_traducciomap(traducciomapid, idiomaid, valor) VALUES (97, 'ca', 'Regweb 3.2');
INSERT INTO car_traducciomap(traducciomapid, idiomaid, valor) VALUES (97, 'es', 'Regweb 3.2');
