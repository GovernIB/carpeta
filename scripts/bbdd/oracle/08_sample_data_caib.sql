-- Afegir m閟 dades a la taula d'Entitat #147
...
INSERT INTO car_entitat(entitatid, nomid, codidir3, activa, colormenu, versio, commit, 
            ...
            webentitat, pluginloginid) VALUES (100, 111, 'A04003003', 1, '32814B', '1.1.1', NULL, NULL, NULL, 'caib', 104, 105, 106, 107, 'http://www.caib.es/sites/suportinformatic/es/inicio-5586/?campa=yes', 'suport@caib.es', '971177070', '<p><strong>漏 Govern Illes Balears</strong></p><p><a href="http://www.caib.es/govern/organigrama/area.do?coduo=2390499' || chr(38) || 'amp;lang=ca">Direcci贸 General de Comunicaci贸</a><a href="http://www.caib.es/govern/organigrama/planol.do?coduo=2390499' || chr(38) || 'amp;lang=ca">: Passeig de Sagrera, 2 - 07012 Palma</a></p><p></p>Tel猫fon 971177166 - Fax 971176348<p></p>', 'https://www.caib.es', NULL);



-- ENlla莽os de tipus XARXA SOCIAL
...
INSERT INTO car_traducciomap(traducciomapid, idiomaid, valor)  VALUES (223, 'ca', 'Not铆cies');
...
INSERT INTO car_traducciomap(traducciomapid, idiomaid, valor)  VALUES (233, 'ca', 'Administraci贸');
INSERT INTO car_traducciomap(traducciomapid, idiomaid, valor)  VALUES (233, 'es', 'Administraci贸n');
...
INSERT INTO car_traducciomap(traducciomapid, idiomaid, valor)  VALUES (253, 'ca', 'Av韘 Legal');
...
--11/02/2021 Nou plugin de Registre atacants als nous m鑤odes de RegWeb 3.2 #333
