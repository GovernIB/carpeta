...
es.caib.carpeta.pluginsib.carpetafront.reprendretramitsistra.pass=[=SP["es.caib.carpeta.pluginsib.carpetafront.sistra1.pass"]]', true, 143, NULL, 'reprendretramit');
