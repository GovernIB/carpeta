...
var PaginationCarpeta = /** @class */ (function (_super) {
    ...
    function PaginationCarpeta(props) {
        ...
        console.log("XYZ ZZZ Abans de condicional selectElementsByPage " + _this.props.paginationInfo.selectElementsByPage);
        if (!_this.props.paginationInfo.selectElementsByPage || _this.props.paginationInfo.selectElementsByPage == undefined) {
            console.log("XYZ ZZZ Dins el IF selectElementsByPage ");
            _this.props.paginationInfo.selectElementsByPage = [5, 10, 25];
        }
        return _this;
    }
        ...
        if (onClickSelectElementsByPage) {
            ...
            */
            for (var i = 0; i < this.props.paginationInfo.selectElementsByPage.length; i++) {
                numElementOptions.push(React$1.createElement("option", { key: i }, this.props.paginationInfo.selectElementsByPage[i]));
            }
