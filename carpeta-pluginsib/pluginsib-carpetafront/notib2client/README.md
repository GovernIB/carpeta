# carpeta-pluginsib-carpetafront-notib2client
...
<dependency>
  ...
  <artifactId>carpeta-pluginsib-carpetafront-notib2client</artifactId>
  <version>2.0</version>
  <scope>compile</scope>
</dependency>
```
...
```groovy
  repositories {
    mavenCentral()     // Needed if the 'carpeta-pluginsib-carpetafront-notib2client' jar has been published to maven central.
    mavenLocal()       // Needed if the 'carpeta-pluginsib-carpetafront-notib2client' jar has been published to the local maven repo.
  }

  dependencies {
     implementation "es.caib.carpeta:carpeta-pluginsib-carpetafront-notib2client:2.0"
  }
```
...
- `target/carpeta-pluginsib-carpetafront-notib2client-2.0.jar`
- `target/lib/*.jar`
