...
class Regweb extends Component {
  constructor(props) {
    ...
    console.log(
      "RegWeb::CONSTRUCTOR this.props.detallpathtoservei => ]" +
        this.props.detallpathtoservei +
        "["
    );
    console.log(
      "RegWeb::CONSTRUCTOR props.detallpathtoservei => ]" +
        props.detallpathtoservei +
        "["
    );

    console.log(
      "RegWeb::CONSTRUCTOR this.props.numeroregistro => ]" +
        this.props.numeroregistro +
        "["
    );
    console.log(
      "RegWeb::CONSTRUCTOR props.numeroregistro => ]" +
    ...
    this.handleStartDateFilterParam =
      this.handleStartDateFilterParam.bind(this);
    ...
    this.handleRegPorPaginaFilterParam =
      this.handleRegPorPaginaFilterParam.bind(this);
  ...
  handleSubmitSearcher(e) {
    ...
    if (validatFormulari) {
      ...
      let criterisCercaText =
        ...
        (this.state.filter_number != null
          ? t("carpeta_criterio_5") + this.state.filter_number
          : "");
  ...
  componentDidMount() {
    ...
    console.log(
      "RegWeb::componentDidMount props.numeroregistro => ]" +
        props.numeroregistro +
        "["
    );
    ...
    console.log(
      "RegWeb::componentDidMount numeroRegistro => ]" + numeroRegistro + "["
    );
    ...
    console.log(
      "RegWeb::componentDidMount numeroRegistro NETEJAT => ]" +
        numeroRegistro +
        "["
    );
    ...
    if (numeroRegistro) {
      console.log(
        "RegWeb::componentDidMount cridant a Detall de Registre => ]" +
          numeroRegistro +
          "["
      );
      this.setState({
  ...
  validaFormulari() {
    if (
      !this.validaFecha(this.state.filter_startDate) ||
      !this.validaFecha(this.state.filter_endDate)
    ) {
      return false;
    }

    if (
      Date.parse(this.state.filter_startDate) >
      Date.parse(this.state.filter_endDate)
    ) {
  ...
  componentDidUpdate() {
    ...
    if (
      ...
      let pageNumbers = Math.ceil(
        this.state.pagination_total_items / this.state.cercaRegistres
      );
          ...
          <div style={{ float: "left", marginTop: "9px", width: "60%" }}>
            {t("carpeta_paginacion_1") +
              ...
              (parseInt(this.state.pagination_active, 10) *
                parseInt(this.state.cercaRegistres, 10) <=
              parseInt(this.state.pagination_total_items, 10)
                ? parseInt(this.state.pagination_active, 10) *
                  parseInt(this.state.cercaRegistres, 10)
              ...
              <Col className="col-xs-12 mb-3 campFormApp">
                <Form.Group>
                  ...
                  <DatePicker
                    ...
                    onChange={(startDate) =>
                      this.handleStartDateFilterParam(startDate)
                    }
                    selectsStart
              ...
              <Col className="col-xs-12 mb-3 campFormApp">
                <Form.Group>
                  ...
                  <DatePicker
                    ...
                    onChange={(endDate) =>
                      this.handleEndDateFilterParam(endDate)
                    }
                    selectsEnd
                    //startDate={this.state.filter_startDate}
                    //endDate={this.state.filter_endDate}
