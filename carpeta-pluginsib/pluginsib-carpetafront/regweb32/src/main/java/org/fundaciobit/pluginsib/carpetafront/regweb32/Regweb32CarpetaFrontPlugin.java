...
public class Regweb32CarpetaFrontPlugin extends RegwebDetallComponent {
    ...
    public void esperaDetall(String absolutePluginRequestPath, String relativePluginRequestPath,
            String query, HttpServletRequest request, HttpServletResponse response,
            UserData userData, String administrationEncriptedID, int pageNumber, Locale locale,
            boolean isGet) {
        ...
        try {
            ...
            String rutaDesti = absolutePluginRequestPath + "/" + DETALL_REGISTRE_PAGE
    ...
    protected static final String ESPERA_DETALL_CODIFICAT_PAGE = "esperadetallcodificat";

    public void esperaDetallCodificat(String absolutePluginRequestPath,
            String relativePluginRequestPath, String query, HttpServletRequest request,
            HttpServletResponse response, UserData userData, String administrationEncriptedID,
            int pageNumber, Locale locale, boolean isGet) {

        try {

            // DETALL_REGISTRE_PAGE + "?numeroRegistroFormateado=" + parameter;
            String numeroRegistroFormateado = request.getParameter("numeroRegistroFormateado");
            String rutaDesti = absolutePluginRequestPath + "/" + DETALL_REGISTRE_CODIFICAT_PAGE
                    + "?numeroRegistroFormateado=" + numeroRegistroFormateado;
            esperaPage(absolutePluginRequestPath, response, locale, rutaDesti);
    ...
    public String getLlistatDeRegistresPage(String absolutePluginRequestPath,
        ...
        String[] traduccions = { "registro.listado", "registro.descripcion", "registro.numero",
                ...
                "carpeta.acciones", "registro.estado", "registro.detalle", "carpeta.fecha.inicio",
                "carpeta.fecha.fin", "carpeta.todos", "carpeta.buscar", "error.dates", "error.data",
                "boto_tornar" };
        ...
        String urlDetalle = absolutePluginRequestPath + "/" + DETALL_REGISTRE_PAGE
        ...
        int prevUrlIndex = (paginacio.getCurrentIndex() > 1) ? (paginacio.getCurrentIndex() - 1)
                : 1;
        ...
        String pageUrl = absolutePluginRequestPath + "/" + LLISTAT_REGISTRES_PAGE + "?" + parametros
                + "&pageNumber=";
