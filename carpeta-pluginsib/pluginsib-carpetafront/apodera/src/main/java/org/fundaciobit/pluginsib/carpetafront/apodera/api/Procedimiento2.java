 ...
 *       &lt;sequence&gt;
 *         &lt;element name="procedimiento" type="{https://consultaApoderamientos.minhap.es/respuestaConsulta}procedimientoType" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
public class Procedimiento2 {
    ...
    protected List<ProcedimientoType2> procedimiento;
     ...
     * {@link ProcedimientoType2 }
     * 
     * 
     */
    public List<ProcedimientoType2> getProcedimiento() {
        if (procedimiento == null) {
            procedimiento = new ArrayList<ProcedimientoType2>();
        }
