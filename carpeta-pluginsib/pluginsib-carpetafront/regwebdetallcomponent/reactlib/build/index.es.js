...
var DetallRegistre = /** @class */ (function (_super) {
    ...
    DetallRegistre.prototype.generarJustificant = function (url) {
        return __awaiter(this, void 0, void 0, function () {
            var justificantLoader;
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        justificantLoader = document.getElementById("justificantLoader");
    ...
    DetallRegistre.prototype.downloadDoc = function (datafile, dataName) {
        ...
        var just = document.getElementById("justificantEnllaz");
        if (just != null) {
    ...
    DetallRegistre.prototype.mostraTooltip = function () {
        var toolTip = document.getElementById("descripcionTooltip");
        if (toolTip != null) {
            var estiloElemento = toolTip.style.display;
    ...
    DetallRegistre.prototype.render = function () {
        ...
        if (!isLoaded) {
            ...
            if (this.state.data != null) {
                ...
                var iconoDescargar = (React.createElement("span", { className: "oi oi-data-transfer-download mr-2", title: this.props.t("carpeta_descargar") + " " + this.props.t("registro_justificante"), "aria-hidden": "true" }));
                content = (React.createElement(React.Fragment, null,
                                                ...
                                                React.createElement("dl", { className: "row colorGrisApp" },
                                                    ...
                                                    registre.estado && (React.createElement(React.Fragment, null,
                                                        ...
                                                        React.createElement("dd", { className: "col-sm-7" },
                                                            ...
                                                            " ",
                                                            React.createElement("span", { id: "descripcionTooltip", style: { display: "none" } }, this.props.t("registro_estado_explicacion_" + registre.estado))))),
                                                    React.createElement("dt", { className: "col-sm-3 pb-2" }, this.props.t("registro_presencial")),
                                                    React.createElement("dd", { className: "col-sm-7" }, registre.presencial === true ? "Sí" : "No"),
                                            ...
                                            React.createElement("div", { className: "col mr-2 font15" },
                                                ...
                                                registre.anexos && registre.anexos.length > 0 && (React.createElement("table", { className: "table table-hover table-sm colorGrisApp" },
                                                    ...
                                                    React.createElement("tbody", null, registre.anexos.map(function (item, index) { return (React.createElement("tr", null,
                                                        ...
                                                        React.createElement("td", null, _this.props.t("registro_anexo_validezdocumento_" + item.validezDocumento)),
                                                        React.createElement("td", null, !item.confidencial ? (item.mime != "" ? (React.createElement("button", { type: "button", className: "d-sm-inline-block btn btn-sm btn-danger shadow-sm", onClick: function () { return _this.descarregarAnnex(item.fileID); } },
                                                            React.createElement("span", { className: "oi oi-data-transfer-download", title: _this.props.t("registro_anexo_descargar") + " " + item.name, "aria-hidden": "true" }))) : (_this.props.t("registro_anexo_nodisponible"))) : (_this.props.t("registro_anexo_confidencial"))))); })))),
...
var registro_titulo_detalle$2 = "Detall del Registre d'entrada amb NÚM. REG.";
...
var registro_tipo_interesado_1$2 = "Administració";
var registro_tipo_interesado_2$2 = "Persona Física";
var registro_tipo_interesado_3$2 = "Persona Jurídica";
var registro_idioma_1$2 = "Català";
var registro_idioma_2$2 = "Castellà";
...
var registro_estado_4$2 = "Remès a destinació";
var registro_estado_5$2 = "Acceptat";
var registro_estado_6$2 = "Acceptat";
var registro_estado_7$2 = "Acceptat";
var registro_estado_8$2 = "Anul·lat";
var registro_estado_9$2 = "Rectificat";
var registro_estado_10$2 = "Rebutjat a destinació";
var registro_estado_11$2 = "Reenviat";
var registro_estado_12$2 = "Acceptat";
var registro_estado_13$2 = "Remès a destinació";
var registro_estado_explicacion_1$2 = "La sol·licitud ha tengut entrada en el registre electrònic general del GOIB.";
var registro_estado_explicacion_2$2 = "La sol·licitud ha tengut entrada en el registre electrònic general del GOIB.";
var registro_estado_explicacion_3$2 = "Registre en estat Reserva";
var registro_estado_explicacion_4$2 = "La sol·licitud s’ha enviat a l’òrgan administratiu destí de la sol·licitud";
var registro_estado_explicacion_5$2 = "La sol·licitud ha tengut entrada en el registre electrònic general del GOIB.";
var registro_estado_explicacion_6$2 = "La sol·licitud ha tengut entrada en el registre electrònic general del GOIB.";
var registro_estado_explicacion_7$2 = "La sol·licitud ha tengut entrada en el registre electrònic general del GOIB.";
var registro_estado_explicacion_8$2 = "Registre en estat Anul·lat";
var registro_estado_explicacion_9$2 = "Registre en estat Rectificat";
var registro_estado_explicacion_10$2 = "La sol·licitud ha estat rebutjada per l'òrgan administratiu destí de la sol·licitud";
var registro_estado_explicacion_11$2 = "La sol·licitud ha estat reenviada d’un òrgan administratiu a un altre, per motius de competències";
var registro_estado_explicacion_12$2 = "La sol·licitud ha tengut entrada en el registre electrònic general del GOIB.";
var registro_estado_explicacion_13$2 = "La sol·licitud s’ha enviat a l’òrgan administratiu destí de la sol·licitud";
var registro_anexo_validezdocumento_1$2 = "Còpia";
var registro_anexo_validezdocumento_3$2 = "Còpia Original";
...
var registro_titulo_detalle$1 = "Detalle del Registro de entrada con NÚM. REG.";
...
var registro_codigoSia$1 = "Código SIA";
...
var registro_anexos_nodisponibles$1 = "Los anexos estarán disponibles durante 90 días desde la fecha del registro.";
var registro_anexos_vacio$1 = "No hay ningún anexo adjunto en el registro";
var registro_anexo_mime$1 = "Formato";
var registro_anexo_tipomime$1 = "Tipo de Archivo";
var registro_tipo_interesado_1$1 = "Administración";
var registro_tipo_interesado_2$1 = "Persona Física";
var registro_tipo_interesado_3$1 = "Persona Jurídica";
var registro_idioma_1$1 = "Catalán";
...
var registro_estado_explicacion_1$1 = "La solicitud ha tenido entrada en el registro electrónico general del GOIB.";
var registro_estado_explicacion_2$1 = "La solicitud ha tenido entrada en el registro electrónico general del GOIB.";
var registro_estado_explicacion_3$1 = "Registro en estado Reserva";
var registro_estado_explicacion_4$1 = "La solicitud se ha enviado al órgano administrativo destino de la solicitud";
var registro_estado_explicacion_5$1 = "La solicitud ha tenido entrada en el registro electrónico general del GOIB.";
var registro_estado_explicacion_6$1 = "La solicitud ha tenido entrada en el registro electrónico general del GOIB.";
var registro_estado_explicacion_7$1 = "La solicitud ha tenido entrada en el registro electrónico general del GOIB.";
...
var registro_estado_explicacion_10$1 = "La solicitud ha sido rechazada por el órgano administrativo destino de la solicitud";
var registro_estado_explicacion_11$1 = "La solicitud ha sido reenviada de un órgano administrativo a otro, per motivos de competencias";
var registro_estado_explicacion_12$1 = "La solicitud ha tenido entrada en el registro electrónico general del GOIB.";
var registro_estado_explicacion_13$1 = "La solicitud se ha enviado al órgano administrativo destino de la solicitud";
...
var registro_titulo_detalle = "Detall del Registre d'entrada amb NÚM. REG.";
...
var registro_tipo_interesado_1 = "Administració";
var registro_tipo_interesado_2 = "Persona Física";
var registro_tipo_interesado_3 = "Persona Jurídica";
var registro_idioma_1 = "Català";
var registro_idioma_2 = "Castellà";
var registro_estado_todos = "Tots";
var registro_estado_1 = "Acceptat";
var registro_estado_2 = "Reserva";
var registro_estado_3 = "Acceptat";
var registro_estado_4 = "Remès a destinació";
var registro_estado_5 = "Acceptat";
var registro_estado_6 = "Acceptat";
var registro_estado_7 = "Acceptat";
var registro_estado_8 = "Anul·lat";
var registro_estado_9 = "Rectificat";
var registro_estado_10 = "Rebutjat a destinació";
var registro_estado_11 = "Reenviat";
var registro_estado_12 = "Acceptat";
var registro_estado_13 = "Remès a destinació";
var registro_estado_explicacion_1 = "La sol·licitud ha tengut entrada en el registre electrònic general del GOIB.";
var registro_estado_explicacion_2 = "La sol·licitud ha tengut entrada en el registre electrònic general del GOIB.";
var registro_estado_explicacion_3 = "Registre en estat Reserva";
var registro_estado_explicacion_4 = "La sol·licitud s’ha enviat a l’òrgan administratiu destí de la sol·licitud";
var registro_estado_explicacion_5 = "La sol·licitud ha tengut entrada en el registre electrònic general del GOIB.";
var registro_estado_explicacion_6 = "La sol·licitud ha tengut entrada en el registre electrònic general del GOIB.";
var registro_estado_explicacion_7 = "La sol·licitud ha tengut entrada en el registre electrònic general del GOIB.";
var registro_estado_explicacion_8 = "Registre en estat Anul·lat";
var registro_estado_explicacion_9 = "Registre en estat Rectificat";
var registro_estado_explicacion_10 = "La sol·licitud ha estat rebutjada per l'òrgan administratiu destí de la sol·licitud";
var registro_estado_explicacion_11 = "La sol·licitud ha estat reenviada d’un òrgan administratiu a un altre, per motius de competències";
var registro_estado_explicacion_12 = "La sol·licitud ha tengut entrada en el registre electrònic general del GOIB.";
var registro_estado_explicacion_13 = "La sol·licitud s’ha enviat a l’òrgan administratiu destí de la sol·licitud";
var registro_anexo_validezdocumento_1 = "Còpia";
var registro_anexo_validezdocumento_3 = "Còpia Original";
