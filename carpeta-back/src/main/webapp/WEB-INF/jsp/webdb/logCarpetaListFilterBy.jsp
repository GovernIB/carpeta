      ...
      <div class="input-group" style="padding-right: 4px;padding-bottom: 4px;">
        ...
        <c:if test="${gen:contains(__theFilterForm.filterByFields ,LogCarpetaFields.LOGID)}">
            ...
            <%-- FILTRE NUMERO DESDE-FINS --%>
              ...
              <form:input cssClass="input-append input-small" path="logIDDesde" />


              <span class="add-on">&nbsp;<fmt:message key="genapp.to" />&nbsp;</span>

              <form:input cssClass="input-append input-small search-query" path="logIDFins" />

            </div>


        </c:if>
        <c:if test="${gen:contains(__theFilterForm.filterByFields ,LogCarpetaFields.DESCRIPCIO)}">
            <%-- FILTRE STRING --%>
            <div class="input-prepend" style="padding-right: 4px;padding-bottom: 4px;">
              <fmt:message key="logCarpeta.descripcio" var="descripcio" />
        ...
        <c:if test="${gen:contains(__theFilterForm.filterByFields ,LogCarpetaFields.TIPUS)}">
            <div class="input-group" style="padding-right: 4px;padding-bottom: 4px;">
              ...
              <div class="input-group-prepend" style="min-width:200px">
                <form:select id="log_tipus_select" path="tipusSelect" cssClass="search-query input-medium form-control select2 select2-hidden-accessible" multiple="true" style="width:100%;" tabindex="-1" aria-hidden="true">
        ...
        <c:if test="${gen:contains(__theFilterForm.filterByFields ,LogCarpetaFields.ESTAT)}">
            <div class="input-group" style="padding-right: 4px;padding-bottom: 4px;">
              ...
              <div class="input-group-prepend" style="min-width:200px">
                <form:select id="log_estat_select" path="estatSelect" cssClass="search-query input-medium form-control select2 select2-hidden-accessible" multiple="true" style="width:100%;" tabindex="-1" aria-hidden="true">
        ...
        <c:if test="${gen:contains(__theFilterForm.filterByFields ,LogCarpetaFields.PLUGINID)}">
            <div class="input-group" style="padding-right: 4px;padding-bottom: 4px;">
              ...
              <div class="input-group-prepend" style="min-width:200px">
                <form:select id="log_pluginID_select" path="pluginIDSelect" cssClass="search-query input-medium form-control select2 select2-hidden-accessible" multiple="true" style="width:100%;" tabindex="-1" aria-hidden="true">
        ...
        <c:if test="${gen:contains(__theFilterForm.filterByFields ,LogCarpetaFields.ENTITATCODI)}">
            <%-- FILTRE STRING --%>
            <div class="input-prepend" style="padding-right: 4px;padding-bottom: 4px;">
              <fmt:message key="logCarpeta.entitatCodi" var="entitatCodi" />
              <fmt:message key="genapp.form.searchby" var="cercaperentitatCodi" >                
                 <fmt:param value="${entitatCodi}"/>
              </fmt:message>
              <span class="add-on"><c:out value="${entitatCodi}" />:</span>
              <form:input cssClass="search-query input-medium" placeholder="${cercaperentitatCodi}" path="entitatCodi" />
            </div>
        ...
        <c:if test="${gen:contains(__theFilterForm.filterByFields ,LogCarpetaFields.TEMPS)}">
            ...
            <%-- FILTRE NUMERO DESDE-FINS --%>
              ...
              <form:input cssClass="input-append input-small" path="tempsDesde" />


              <span class="add-on">&nbsp;<fmt:message key="genapp.to" />&nbsp;</span>

              <form:input cssClass="input-append input-small search-query" path="tempsFins" />
...
<%-- FILTRE DATE-TIME --%>
        ...
        <c:if test="${gen:contains(__theFilterForm.filterByFields ,LogCarpetaFields.PETICIO)}">
            <%-- FILTRE STRING --%>
            <div class="input-prepend" style="padding-right: 4px;padding-bottom: 4px;">
              <fmt:message key="logCarpeta.peticio" var="peticio" />
              <fmt:message key="genapp.form.searchby" var="cercaperpeticio" >                
                 <fmt:param value="${peticio}"/>
              </fmt:message>
              <span class="add-on"><c:out value="${peticio}" />:</span>
              <form:input cssClass="search-query input-medium" placeholder="${cercaperpeticio}" path="peticio" />
            </div>


        </c:if>
        <c:if test="${gen:contains(__theFilterForm.filterByFields ,LogCarpetaFields.ERROR)}">
            <%-- FILTRE STRING --%>
            <div class="input-prepend" style="padding-right: 4px;padding-bottom: 4px;">
              <fmt:message key="logCarpeta.error" var="error" />
        ...
        <c:if test="${gen:contains(__theFilterForm.filterByFields ,LogCarpetaFields.EXCEPCIO)}">
            <%-- FILTRE STRING --%>
            <div class="input-prepend" style="padding-right: 4px;padding-bottom: 4px;">
              <fmt:message key="logCarpeta.excepcio" var="excepcio" />
              <fmt:message key="genapp.form.searchby" var="cercaperexcepcio" >                
                 <fmt:param value="${excepcio}"/>
              </fmt:message>
              <span class="add-on"><c:out value="${excepcio}" />:</span>
              <form:input cssClass="search-query input-medium" placeholder="${cercaperexcepcio}" path="excepcio" />
            </div>
