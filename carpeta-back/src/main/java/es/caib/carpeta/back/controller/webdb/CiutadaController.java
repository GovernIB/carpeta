 ...
 * @author GenApp
 */
@MenuOption(labelCode="ciutada.ciutada.plural", order=30, group=Tab.MENU_WEBDB)
@Controller
@RequestMapping(value = "/webdb/ciutada")
@SessionAttributes(types = { CiutadaForm.class, CiutadaFilterForm.class })
@Tile(name="ciutadaFormWebDB", contentJsp="/WEB-INF/jsp/webdb/ciutadaForm.jsp", extendsTile=Tab.MENU_WEBDB,
      type=TileType.WEBDB_FORM , attributes={ @TileAttribute(name="titol", value="ciutada.ciutada")})
@Tile(name="ciutadaListWebDB", contentJsp="/WEB-INF/jsp/webdb/ciutadaList.jsp", extendsTile=Tab.MENU_WEBDB,
       type=TileType.WEBDB_LIST, attributes={ @TileAttribute(name="titol", value="ciutada.ciutada") })
...
public java.lang.Long stringToPK(String value) {
 ...
 exceptionMsg };
  ...
  /**
   * Entra aqui al pitjar el boto cancel en el la creació de Ciutada
   */
  @RequestMapping(value = "/cancel")
  public String cancelCiutada(HttpServletRequest request,HttpServletResponse response) {
