 ...
 * @author GenApp
 */
@MenuOption(labelCode="auditoria.auditoria.plural", order=10, group=Tab.MENU_WEBDB)
@Controller
...
public java.lang.Long stringToPK(String value) {
 ...
 exceptionMsg };
  ...
  /**
   * Entra aqui al pitjar el boto cancel en el la creació de Auditoria
   */
  @RequestMapping(value = "/cancel")
  public String cancelAuditoria(HttpServletRequest request,HttpServletResponse response) {
