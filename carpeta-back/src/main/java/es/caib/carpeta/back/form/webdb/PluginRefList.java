...
import es.caib.carpeta.ejb.PluginService;
...
public class PluginRefList extends RefListBase
  ...
  public PluginRefList() {
    ...
    addCampTraduible(TITOLLLARGID.select);
    addCampTraduible(SUBTITOLLLARGID.select);
  }
  public List<StringKeyValue> getReferenceList(Field<?> keyField, Where where, OrderBy ... orderBy) throws I18NException {
    ...
    org.fundaciobit.genapp.common.query.Where _w1 = es.caib.carpeta.model.fields.TraduccioFields.TRADUCCIOID.in(pluginEjb.executeQuery(_transSelect, where));
