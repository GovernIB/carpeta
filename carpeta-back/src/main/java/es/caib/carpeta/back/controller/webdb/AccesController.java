 ...
 * @author GenApp
 */
@MenuOption(labelCode="acces.acces.plural", order=0, group=Tab.MENU_WEBDB)
@Controller
@RequestMapping(value = "/webdb/acces")
@SessionAttributes(types = { AccesForm.class, AccesFilterForm.class })
@Tile(name="accesFormWebDB", contentJsp="/WEB-INF/jsp/webdb/accesForm.jsp", extendsTile=Tab.MENU_WEBDB,
      type=TileType.WEBDB_FORM , attributes={ @TileAttribute(name="titol", value="acces.acces")})
@Tile(name="accesListWebDB", contentJsp="/WEB-INF/jsp/webdb/accesList.jsp", extendsTile=Tab.MENU_WEBDB,
       type=TileType.WEBDB_LIST, attributes={ @TileAttribute(name="titol", value="acces.acces") })
...
public java.lang.Long stringToPK(String value) {
 ...
 exceptionMsg };
  ...
  public void initBinderForm(WebDataBinder binder) {
    ...
    initDisallowedFields(binder, "acces.accesID");
  }
  ...
  /**
   * Entra aqui al pitjar el boto cancel en el la creació de Acces
   */
  @RequestMapping(value = "/cancel")
  public String cancelAcces(HttpServletRequest request,HttpServletResponse response) {
