 ...
 * @author GenApp
 */
@MenuOption(labelCode="logCarpeta.logCarpeta.plural", order=90, group=Tab.MENU_WEBDB)
@Controller
@RequestMapping(value = "/webdb/logCarpeta")
@SessionAttributes(types = { LogCarpetaForm.class, LogCarpetaFilterForm.class })
@Tile(name="logCarpetaFormWebDB", contentJsp="/WEB-INF/jsp/webdb/logCarpetaForm.jsp", extendsTile=Tab.MENU_WEBDB,
      type=TileType.WEBDB_FORM , attributes={ @TileAttribute(name="titol", value="logCarpeta.logCarpeta")})
@Tile(name="logCarpetaListWebDB", contentJsp="/WEB-INF/jsp/webdb/logCarpetaList.jsp", extendsTile=Tab.MENU_WEBDB,
       type=TileType.WEBDB_LIST, attributes={ @TileAttribute(name="titol", value="logCarpeta.logCarpeta") })
...
public java.lang.Long stringToPK(String value) {
 ...
 exceptionMsg };
  ...
  /**
   * Entra aqui al pitjar el boto cancel en el la creació de LogCarpeta
   */
  @RequestMapping(value = "/cancel")
  public String cancelLogCarpeta(HttpServletRequest request,HttpServletResponse response) {
  ...
  public void delete(HttpServletRequest request, LogCarpeta logCarpeta) throws I18NException {
