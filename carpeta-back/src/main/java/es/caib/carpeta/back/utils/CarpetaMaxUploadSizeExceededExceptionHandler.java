 ...
 * 
 */
public class CarpetaMaxUploadSizeExceededExceptionHandler implements
  ...
  public ModelAndView resolveException(HttpServletRequest request,
    ...
    if (ex instanceof CarpetaMaxUploadSizeExceededException
      ...
      if (ex instanceof MaxUploadSizeExceededException) {
        ...
        if (musee instanceof CarpetaMaxUploadSizeExceededException) {
          msgCode = ((CarpetaMaxUploadSizeExceededException) musee).getMsgCode();
        } else {
