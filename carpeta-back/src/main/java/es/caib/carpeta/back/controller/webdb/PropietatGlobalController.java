 ...
 * @author GenApp
 */
@MenuOption(labelCode="propietatGlobal.propietatGlobal.plural", order=140, group=Tab.MENU_WEBDB)
@Controller
...
public class PropietatGlobalController
  ...
  public String crearPropietatGlobalPost(@ModelAttribute PropietatGlobalForm propietatGlobalForm,
    ...
    try {
      ...
      if (result.hasErrors()) {
        ...
        createMessageSuccess(request, "success.creation", propietatGlobal.getPropietaGlobalID());
  ...
  @RequestMapping(value = "/view/{propietaGlobalID}", method = RequestMethod.GET)
  public ModelAndView veurePropietatGlobalGet(@PathVariable("propietaGlobalID") java.lang.Long propietaGlobalID,
      HttpServletRequest request,
      HttpServletResponse response) throws I18NException {
      return editAndViewPropietatGlobalGet(propietaGlobalID,
        request, response, true);
  }


  protected ModelAndView editAndViewPropietatGlobalGet(@PathVariable("propietaGlobalID") java.lang.Long propietaGlobalID,
      HttpServletRequest request,
    ...
    PropietatGlobalJPA propietatGlobal = findByPrimaryKey(request, propietaGlobalID);

    if (propietatGlobal == null) {
      createMessageWarning(request, "error.notfound", propietaGlobalID);
   ...
   */
  @RequestMapping(value = "/{propietaGlobalID}/edit", method = RequestMethod.GET)
  public ModelAndView editarPropietatGlobalGet(@PathVariable("propietaGlobalID") java.lang.Long propietaGlobalID,
      HttpServletRequest request,
      HttpServletResponse response) throws I18NException {
      return editAndViewPropietatGlobalGet(propietaGlobalID,
   ...
   */
  @RequestMapping(value = "/{propietaGlobalID}/edit", method = RequestMethod.POST)
  public String editarPropietatGlobalPost(@ModelAttribute PropietatGlobalForm propietatGlobalForm,
    ...
    try {
      ...
      if (result.hasErrors()) {
        ...
        createMessageSuccess(request, "success.modification", propietatGlobal.getPropietaGlobalID());
        status.setComplete();
      ...
      String msg = createMessageError(request, "error.modification",
          propietatGlobal.getPropietaGlobalID(), __e);
      log.error(msg, __e);
   ...
   */
  @RequestMapping(value = "/{propietaGlobalID}/delete")
  public String eliminarPropietatGlobal(@PathVariable("propietaGlobalID") java.lang.Long propietaGlobalID,
      HttpServletRequest request,HttpServletResponse response) {
    ...
    try {
      PropietatGlobal propietatGlobal = this.findByPrimaryKey(request, propietaGlobalID);
      if (propietatGlobal == null) {
        String __msg = createMessageError(request, "error.notfound", propietaGlobalID);
        return getRedirectWhenDelete(request, propietaGlobalID, new Exception(__msg));
      } else {
        delete(request, propietatGlobal);
        createMessageSuccess(request, "success.deleted", propietaGlobalID);
        return getRedirectWhenDelete(request, propietaGlobalID,null);
      }

    } catch (Throwable e) {
      String msg = createMessageError(request, "error.deleting", propietaGlobalID, e);
      log.error(msg, e);
      return getRedirectWhenDelete(request, propietaGlobalID, e);
    }
  }
...
public java.lang.Long stringToPK(String value) {
  ...
  @Override
  public String[] getArgumentsMissatge(Object __propietaGlobalID, Throwable e) {
    java.lang.Long propietaGlobalID = (java.lang.Long)__propietaGlobalID;
    String exceptionMsg = "";
    if (e != null) {
    ...
    if (propietaGlobalID == null) {
      return new String[] { I18NUtils.tradueix(getEntityNameCode()),
         getPrimaryKeyColumnsTranslated(), null, exceptionMsg };
    } else {
      return new String[] { I18NUtils.tradueix(getEntityNameCode()),
        getPrimaryKeyColumnsTranslated(),
         String.valueOf(propietaGlobalID),
 exceptionMsg };
    }
  }
  ...
  public String getPrimaryKeyColumnsTranslated() {
    return  I18NUtils.tradueix("propietatGlobal.propietaGlobalID");
  }
   ...
   */
  @RequestMapping(value = "/{propietaGlobalID}/cancel")
  public String cancelPropietatGlobal(@PathVariable("propietaGlobalID") java.lang.Long propietaGlobalID,
      HttpServletRequest request,HttpServletResponse response) {
     return getRedirectWhenCancel(request, propietaGlobalID);
  }

  /**
   * Entra aqui al pitjar el boto cancel en el la creació de PropietatGlobal
   */
  @RequestMapping(value = "/cancel")
  public String cancelPropietatGlobal(HttpServletRequest request,HttpServletResponse response) {
  ...
  public String getRedirectWhenDelete(HttpServletRequest request, java.lang.Long propietaGlobalID, Throwable __e) {
    return "redirect:" + getContextWeb() + "/list";
  }

  public String getRedirectWhenCancel(HttpServletRequest request, java.lang.Long propietaGlobalID) {
    return "redirect:" + getContextWeb() + "/list";
  }
  ...
  public PropietatGlobalJPA findByPrimaryKey(HttpServletRequest request, java.lang.Long propietaGlobalID) throws I18NException {
    return (PropietatGlobalJPA) propietatGlobalEjb.findByPrimaryKey(propietaGlobalID);
  }
