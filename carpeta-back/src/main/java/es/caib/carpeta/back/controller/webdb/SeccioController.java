 ...
 * @author GenApp
 */
@MenuOption(labelCode="seccio.seccio.plural", order=150, group=Tab.MENU_WEBDB)
@Controller
@RequestMapping(value = "/webdb/seccio")
@SessionAttributes(types = { SeccioForm.class, SeccioFilterForm.class })
@Tile(name="seccioFormWebDB", contentJsp="/WEB-INF/jsp/webdb/seccioForm.jsp", extendsTile=Tab.MENU_WEBDB,
      type=TileType.WEBDB_FORM , attributes={ @TileAttribute(name="titol", value="seccio.seccio")})
@Tile(name="seccioListWebDB", contentJsp="/WEB-INF/jsp/webdb/seccioList.jsp", extendsTile=Tab.MENU_WEBDB,
       type=TileType.WEBDB_LIST, attributes={ @TileAttribute(name="titol", value="seccio.seccio") })
...
public java.lang.Long stringToPK(String value) {
 ...
 exceptionMsg };
  ...
  /**
   * Entra aqui al pitjar el boto cancel en el la creació de Seccio
   */
  @RequestMapping(value = "/cancel")
  public String cancelSeccio(HttpServletRequest request,HttpServletResponse response) {
