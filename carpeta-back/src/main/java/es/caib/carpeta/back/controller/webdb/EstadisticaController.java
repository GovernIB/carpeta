 ...
 * @author GenApp
 */
@MenuOption(labelCode="estadistica.estadistica.plural", order=60, group=Tab.MENU_WEBDB)
@Controller
...
public class EstadisticaController
  ...
  public String editarEstadisticaPost(@ModelAttribute EstadisticaForm estadisticaForm,
...
public java.lang.Long stringToPK(String value) {
 ...
 exceptionMsg };
  ...
  /**
   * Entra aqui al pitjar el boto cancel en el la creació de Estadistica
   */
  @RequestMapping(value = "/cancel")
  public String cancelEstadistica(HttpServletRequest request,HttpServletResponse response) {
