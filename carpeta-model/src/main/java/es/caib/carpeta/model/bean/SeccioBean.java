...
public class SeccioBean implements Seccio {
  ...
  public SeccioBean(long seccioID , long nomID , long descripcioID , java.lang.String contexte , boolean activa , long iconaID , java.lang.Long seccioPareID , long entitatID , int ordre) {
  ...
  public SeccioBean(long nomID , long descripcioID , boolean activa , long iconaID , java.lang.Long seccioPareID , long entitatID , int ordre) {
    this.nomID=nomID;
    this.descripcioID=descripcioID;
    this.activa=activa;
    this.iconaID=iconaID;
  ...
  public SeccioBean(long seccioID , long nomID , long descripcioID , java.lang.String contexte , boolean activa , long iconaID , long entitatID , int ordre) {
    this.seccioID=seccioID;
    this.nomID=nomID;
    this.descripcioID=descripcioID;
    this.contexte=contexte;
