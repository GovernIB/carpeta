...
public interface IAvisManager extends org.fundaciobit.genapp.common.query.ITableManager<Avis, Long> {
	...
	public Avis create( long _descripcioID_, long _entitatID_, java.sql.Timestamp _dataInici_, java.sql.Timestamp _dataFi_, int _tipus_, java.lang.Long _pluginFrontID_) throws I18NException;
