...
/* L'ús d'aquest camp (OneToMany) llança una exception:
 ...
 // TODO Solució dins el mètode testOneByOneDirect de la classe TestJPA 
  ...
  public EnllazQueryPath ENLLAZ_DESCRIPCIOIDS() {
    return new EnllazQueryPath(new QueryPath() {
      public String getQueryPath() {
          return TraduccioQueryPath.this.getQueryPath() + "enllaz_descripcioids" + ".";
      }
    });
  }
*/
...
/* L'ús d'aquest camp (OneToMany) llança una exception:
 ...
 // TODO Solució dins el mètode testOneByOneDirect de la classe TestJPA 
  ...
  public EntitatQueryPath ENTITAT_DESCRIPCIOIDS() {
    return new EntitatQueryPath(new QueryPath() {
      public String getQueryPath() {
          return TraduccioQueryPath.this.getQueryPath() + "entitat_descripcioids" + ".";
      }
    });
  }
*/
...
/* L'ús d'aquest camp (OneToMany) llança una exception:
 ...
 // TODO Solució dins el mètode testOneByOneDirect de la classe TestJPA 
  ...
  public NotificacioAppQueryPath NOTIFICACIOAPP_MISSATGEIDS() {
    return new NotificacioAppQueryPath(new QueryPath() {
      public String getQueryPath() {
          return TraduccioQueryPath.this.getQueryPath() + "notificacioApp_missatgeids" + ".";
      }
    });
  }
*/
...
/* L'ús d'aquest camp (OneToMany) llança una exception:
 ...
 // TODO Solució dins el mètode testOneByOneDirect de la classe TestJPA 
  ...
  public NotificacioAppQueryPath NOTIFICACIOAPP_TITOLIDS() {
    return new NotificacioAppQueryPath(new QueryPath() {
      public String getQueryPath() {
          return TraduccioQueryPath.this.getQueryPath() + "notificacioApp_titolids" + ".";
      }
    });
  }
*/
...
/* L'ús d'aquest camp (OneToMany) llança una exception:
 ...
 // TODO Solució dins el mètode testOneByOneDirect de la classe TestJPA 
  ...
  public PluginQueryPath PLUGIN_SUBTITOLLLARGIDS() {
    return new PluginQueryPath(new QueryPath() {
      public String getQueryPath() {
          return TraduccioQueryPath.this.getQueryPath() + "plugin_subtitolllargids" + ".";
      }
    });
  }
*/
...
/* L'ús d'aquest camp (OneToMany) llança una exception:
 ...
 // TODO Solució dins el mètode testOneByOneDirect de la classe TestJPA 
  ...
  public PluginQueryPath PLUGIN_TITOLLLARGIDS() {
    return new PluginQueryPath(new QueryPath() {
      public String getQueryPath() {
          return TraduccioQueryPath.this.getQueryPath() + "plugin_titolllargids" + ".";
      }
    });
  }
*/
