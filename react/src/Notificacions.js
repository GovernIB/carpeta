                        ...
                        <div className="card-body imc--llista--capses">
                            ...
                            <div className="row mb-5">
                                ...
                                <div className="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                  ...
                                  <span className="oi oi-envelope-closed h3 mt-2 mb-2"
                                        title={t('notificacionsNotificacions')} alt={t('notificacionsNotificacions')}
                                        aria-hidden="true">
                                ...
                                <div className="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                    <button className="card col-md-10 align-items-lg-center" onclick="goTo()">
                                    <span className="oi oi-box h3 mt-2 mb-2" title={t('notificacionsAltres')}
                                          alt={t('notificacionsAltres')} aria-hidden="true">
