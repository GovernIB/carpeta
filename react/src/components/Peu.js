      ...
      <footer className="imc-peu">
        <div className="imc--contingut">
          ...
          <div className="imc-peu-govern">
            <p><strong>{ t('peu.copyright') }</strong></p>

            <p>
              <a href="http://www.caib.es/govern/organigrama/area.do?coduo=2390499&amp;lang=ca">{ t('peu.direccio') }</a><a href="http://www.caib.es/govern/organigrama/planol.do?coduo=2390499&amp;lang=ca">: { t('peu.adresa') }</a></p><p></p>{ t('peu.telefon') }
            <p></p>
          ...
          <div className="imc-peu-opcions">
            <ul>
              <li><a href="http://www.caib.es/sites/M180123085529629/ca/mapa/">{ t('peu.mapa') }</a></li>
              <li><a href="http://www.caib.es/govern/external/infoLegal.do?lang=ca">{ t('peu.avis') }</a></li>
              <li>
                <a href="http://www.caib.es/govern/rss.do?lang=ca" className="imc-en-rss">
                  <span className="mr-1">{ t('peu.rss') }</span>
...
const PeuContingut = withTranslation()(LegacyComponentClass)
