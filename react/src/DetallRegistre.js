                              ...
                              <div className="card-body">
                                  <div className="row no-gutters align-items-center">
                                      <div className="col mr-2">
                                          <div className="font-weight-bold verde text-uppercase mb-3 text-center h3">{ t('detallregistreEntrada') }</div>
                          ...
                          <div className="card border-left-carpeta shadow py-2 mb-3">
                              <div className="card-body">
                                  <div className="row no-gutters">
                                      <div className="col mr-2">
                                          <div className="font-weight-bold verde text-uppercase mb-3 text-center h3">{ t('detallregistreJustificant') }</div>

                                              <div className="text-center">
                                                  <button type="button" className="d-sm-inline-block btn btn-sm btn-danger shadow-sm" onClick={event =>  window.location.href='/descarregar'}><span className="oi oi-data-transfer-download" title="" alt="" aria-hidden="true"></span> { t('detallregistreDescarregar') }</button>
                                              </div>
                      ...
                      <div className="seg-col-deta-reg col-md-6">
                          ...
                          <div className="card border-left-carpeta shadow py-2 mb-3">
                              <div className="card-body">
                                  <div className="row no-gutters align-items-center">
                                      <div className="col mr-2">
                                          <div className="font-weight-bold verde text-uppercase mb-3 text-center h3">{ t('detallregistreInteressats') }</div>
                                          <div className="row no-gutters align-items-center">
                          ...
                          <div className="card border-left-carpeta shadow py-2 mb-3">
                              <div className="card-body">
                                  <div className="row no-gutters align-items-center">
                                      <div className="col mr-2">
                                          <div className="font-weight-bold verde text-uppercase mb-3 text-center h3">{ t('detallregistreAnnexos') }</div>
                                  ...
                                  <div className="card-body">
                                      <div className="row no-gutters align-items-center">
                                          <div className="col mr-2">
                                                  ...
                                                  <div className="font-weight-bold verde text-uppercase mb-3 text-center">{ t('detallregistreExposa') }</div>
                                                  <div className="row no-gutters text-justify mb-4">Estant en una wer wer wer were r</div>

                                                  <div className="font-weight-bold verde text-uppercase mb-3 text-center">{ t('detallregistreSolicita') }</div>
