          ...
          <div className="col-md-12 border-0 float-left p-0">
              ...
              <div className="card-body tablaRegistros">
                ...
                <form method="post" modelAttribute="fechaBusqueda">
                    <div className="row">
                        <div className="col-md-5">
                            <div className="form-group">
                                <label path="fechaInicio" placeholder="dd/mm/yyyy">{ t('tramitspendentsDataInici') }</label>
                        ...
                        <div className="col-md-5">
                            <div className="form-group">
                                <label path="fechaFin" placeholder="dd/mm/yyyy">{ t('tramitspendentsDataFi') }</label>
                                <div className="input-group">
                    ...
                    <button type="submit" className="btn btn-primary carpeta-btn">{ t('tramitspendentsCercar') }</button>
                </form>
