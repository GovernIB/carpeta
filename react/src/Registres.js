                        ...
                        <div className="card-body tablaRegistros">
                            ...
                            <div className="mt-5 table-responsive">
                                ...
                                <table id="dataTable_paginate"
                                    ...
                                    <tbody>
                                    <tr className="clickable-row" data-target=""
                                        data-href="javascript:newDetallRegistre('contingut', '8892020');">
                                        <td>
                                            <label class="ponerMovil" data-toggle="tooltip" data-placement="top"
                                                   title="L17/889-2020">
                                                <a href="javascript:newDetallRegistre('contingut', '8892020');">L17/889-2020</a>
                                            </label>
                                            <p class="quitarMovil mb-0 mt-0"><a
                                                href="javascript:newDetallRegistre('contingut', '8892020');"
                                                rel="noopener noreferrer">L17/889-2020</a></p>
                                        </td>
                                        <td>12/02/20</td>
                                        <td>Registre fet per...</td>
                                        <td>Conselleria de Salut</td>
                                    </tr>
                                    <tr className="clickable-row" data-target="_blank"
                                        data-href="goTo('detallRegistre')">
                                        <td>
                                            <label class="ponerMovil" data-toggle="tooltip" data-placement="top"
                                                   title="L17/901-2020">
                                            ...
                                            <p class="quitarMovil mb-0 mt-0"><a
                                                href="javascript:newDetallRegistre('contingut', '889242');"
                                                rel="noopener noreferrer">L17/901-2020</a></p>
                                        </td>
                                        <td>12/02/20</td>
                                        <td>Registre fet per...</td>
