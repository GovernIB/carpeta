package es.caib.carpeta.api.externa.all.estadistiques;
...
@OpenAPIDefinition(
        info = @Info(
                title = "API REST EXTERNA de Carpeta - Estadistiques d'Accessos",
                description = "Conjunt de Serveis Rest per Accedir a Estadístiques d'Accessos",
                version = "1.0.0",
                license = @License(
        ...
        tags = @Tag(name = Estadistiques.TAG_NAME, description = "Estadístiques d'Accessos"))
public class Estadistiques extends RestUtils {
    ...
    public LlistatPaginatAcces estadistiques(
        ...
        try {
            ...
            GenAppEntityConverter<Acces, AccesDTO> converter = new GenAppEntityConverter<Acces, AccesDTO>() {
                ...
                public AccesDTO convert(Acces item) throws RestException {
                    ...
                    return new AccesDTO(item.getProveidorIdentitat(), item.getMetodeAutenticacio(), item.getQaa(),
                            item.getDataAcces(), item.getIdioma(), entitatFinal, tipusAcces, nomPlugin,
                            item.getIdsessio());
                }
            };
            ...
            */
            return GenAppRestUtils.createRestPagination(LlistatPaginatAcces.class, accesEjb, (int) page, (int) pageSize,
                    w, order, converter, name, nextQuery);
