package es.caib.carpeta.api.externa.secure.certificats;
...
@OpenAPIDefinition(
        info = @Info(
                title = "API REST EXTERNA de Carpeta - Certificats",
                description = "Plantilla de Serveis REST a implementar per servidors externs per des de Carpeta poder accedir a Certificats dels Ciutadans",
                version = "1.0.0",
                license = @License(
        ...
        externalDocs = @ExternalDocumentation(
                ...
                url = "https://github.com/GovernIB/carpeta/tree/carpeta-1.1/carpeta-api-externa-client-certificats"),
        tags = @Tag(name = "Certificats", description = "Certificats"))
    ...
    public Response descarregarCertificat(
        ...
        try {
            ...
            switch (pluginNumber) {
                ...
                case "6": {
                    throw new Exception(
                            "Error simulat: Error obtenint certificat de discapacitat de mock. (No té certificat)");
                }
