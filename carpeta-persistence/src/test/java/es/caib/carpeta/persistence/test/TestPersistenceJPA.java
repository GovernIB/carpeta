...
public class TestPersistenceJPA {
    ...
    public static final void main(String[] args) {
        try {
            ...
            */
             ...
             * IIdiomaManager idioma = CarpetaDaoManager.getDaoManagers().getIdiomaManager();
             * 
    ...
    public static EntityManager initDB() {
        ...
        emf = Persistence.createEntityManagerFactory("carpetaPULocal", prop);

        EntityManager em = emf.createEntityManager();

        em.setFlushMode(FlushModeType.AUTO);
        
        CarpetaDaoManager.setDaoManagers(new CarpetaJPADaoManagers(em)); 
