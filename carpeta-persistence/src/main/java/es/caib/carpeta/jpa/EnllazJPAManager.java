...
public class EnllazJPAManager
  ...
  public EntityManager getEntityManager() {
	...
	public synchronized Enllaz create( int _tipus_, long _nomID_, long _urlID_, long _entitatID_) throws I18NException {
		EnllazJPA __bean =  new EnllazJPA(_tipus_,_nomID_,_urlID_,_entitatID_);
