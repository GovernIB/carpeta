...
public class PluginJPAManager
  ...
  public EntityManager getEntityManager() {
	...
	public synchronized Plugin create( long _nomID_, java.lang.Long _descripcioID_, java.lang.Long _logoID_, java.lang.String _classe_, java.lang.String _propietats_, boolean _actiu_, int _tipus_) throws I18NException {
		PluginJPA __bean =  new PluginJPA(_nomID_,_descripcioID_,_logoID_,_classe_,_propietats_,_actiu_,_tipus_);
