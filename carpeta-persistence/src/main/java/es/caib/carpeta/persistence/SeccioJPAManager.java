...
public class SeccioJPAManager
  ...
  public EntityManager getEntityManager() {
	...
	public synchronized Seccio create( long _nomID_, long _descripcioID_, boolean _activa_, long _iconaID_, java.lang.Long _seccioPareID_) throws I18NException {
		SeccioJPA __bean =  new SeccioJPA(_nomID_,_descripcioID_,_activa_,_iconaID_,_seccioPareID_);
